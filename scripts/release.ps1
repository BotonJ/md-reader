...
## 下载说明
- Windows：下载 .msi 安装版，或 .exe / .zip 绿色版（浏览器拦截 exe 时请下载 zip）。
- macOS / Linux：实验版，未签名；macOS 首次打开可右键打开，Linux AppImage 需先 chmod +x。
"@
$fullNotes = $notesContent.TrimEnd() + "`n" + $downloadNotes
